	...
	$.fn.extend({
		...
		holderContent:function(){
			$(this).each(function(index, element) {
                var thisHolderContent=$(this),tmpHolderContent=$(this).clone(true),hasHolderContent=$(this).attr('holderContent');
				if(hasHolderContent){
					...
					tmpHolderContent.focus(function(){
							...
							thisHolderContent.addClass('holderContenthover');
					});
					thisHolderContent.blur(function(){
						...
						thisHolderContent.removeClass('holderContenthover');
					});		
				};
		...
		addContentSpecifiedLocation:function(addContentClass,toClassName){
			var that=$(this);
			that.hover(function(){
				that.removeClass('icon_setting_option_bg').addClass('icon_setting_option_bg_hover');
			},function(){
				that.removeClass('icon_setting_option_bg_hover').addClass('icon_setting_option_bg');
			});
			that.one('click',function(){
				bindoneclick()
			});
			function bindoneclick(){
				that.removeClass('icon_setting_option_bg_hover').addClass('icon_setting_option_bg_visited')
				...
				setTimeout(function(){
					that.removeClass('icon_setting_option_bg_visited').addClass('icon_setting_option_bg')
					that.one('click',function(){
						bindoneclick()
					});
				},1500);
